...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='data/5x10')
    ...
    parser.add_argument('--m_items', type=int, default=10)
    ...
    parser.add_argument('--rho_gama_update_freq', type=int, default=500)
